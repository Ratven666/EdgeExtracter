...
class DEMIndexPlotterPlotly:
    ...
    def __calk_indexes(self, cell):
        ...
        try:
            ...
            return None
        x0 = self.model.voxel_model.x_min
        y0 = self.model.voxel_model.y_min
    ...
    def __calk_ax_ticks(self):
        ...
        """
        x_ticks = [self.model.dem_model.voxel_model.x_min + (idx + 0.5) * self.model.dem_model.voxel_model.step
                   for idx in range(self.model.dem_model.voxel_model.x_count)]
        y_ticks = [self.model.dem_model.voxel_model.y_min + (idx + 0.5) * self.model.dem_model.voxel_model.step
