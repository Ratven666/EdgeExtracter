...
class Scan:
    ...
    @property
    def x_min(self):
        return self.borders["x_min"]

    @property
    def x_max(self):
        return self.borders["x_max"]

    @property
    def y_min(self):
        return self.borders["y_min"]

    @property
    def y_max(self):
        return self.borders["y_max"]

    @property
    def z_min(self):
        return self.borders["z_min"]

    @property
    def z_max(self):
        return self.borders["z_max"]
